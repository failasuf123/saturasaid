...
const HeritageOfIndonesiaMaroon = ({ currentUser }: { currentUser: BridalCouple| null }) => {
  ...
  return (
    <div className="flex  flex-col min-h-screen items-center justify-center bg-[url('/template2/bg-maroon.png')] bg-fixed">
...
function Cover({ currentUser, showBtn, onOpenInvitation }: CoverProps) {
  return (
    <div className="flex justify-center items-center relative min-h-screen w-[500px] flex-col bg-[url('/template2/bg-phone-maroon.png')] justify-center pb-10 text-2xl overflow-hidden">      <div className="flex flex-col items-center">
...
function Introduction({ currentUser, isVisible }: IntroductionProps) {
  ...
  const duplicateImages = (imgs: string[]) => {
    ...
    while (duplicatedImages.length < 90) {
  ...
  return (
    <div id="introduction" className={`relative min-h-screen w-[500px] flex flex-col bg-[url('')] text-2xl overflow-hidden snap-center ${isVisible ? 'animate-fade-up' : ''} bg-[url(/template2/bg-phone-maroon.png)]`}>
      <style>
        {`
          @keyframes slide {
            0% {
...
const Greeting = ({ currentUser }: { currentUser: BridalCouple| null }) => {
  ...
  return(
    <div  className="min-h-[500px] h-[700px] relative w-[500px] flex flex-col bg-[url('/template2/bg-phone-maroon.png')] items-center justify-center bg-white text-2xl snap-start snap-always ">
      <motion.div 
        ref={ref}
...
const Bride = ({ currentUser }: { currentUser: BridalCouple| null }) =>  {
  ...
  return (
    <div ref={ref} className="min-h-screen relative w-[500px] flex flex-col justify-between bg-[url('/template2/bg-phone-maroon.png')] items-center bg-white text-2xl snap-start snap-always ">
      <motion.div 
...
const Groom = ({ currentUser }: { currentUser: BridalCouple| null }) =>  {
  ...
  return (
    <div ref={ref} className="min-h-screen relative w-[500px] flex flex-col bg-[url('/template2/bg-phone-maroon.png')] items-center bg-white text-2xl snap-start snap-always ">
      <motion.div 
...
const CountDown: React.FC<{ currentUser: BridalCouple | null }> = ({ currentUser })=> {
  ...
  return (
    ...
    <div className="min-h-screen w-[500px] flex flex-col bg-[url('/template2/bg-phone-maroon.png')] items-center justify-center  text-2xl snap-start snap-always">
      <motion.div 
...
const Place = ({ currentUser }: { currentUser: BridalCouple| null }) =>  {
  ...
  const isInView = useInView(ref, { once: true });
  return (
    <div className="min-h-screen relative w-[500px] text-2xl bg-[url('/template2/bg-phone-maroon.png')] flex flex-col justify-center gap-10 items-center">
...
const Story = ({ currentUser }: { currentUser: BridalCouple| null }) => {
  ...
  const isInView = useInView(ref, { once: true });
  return(
    <div className="min-h-screen relative w-[500px] text-2xl  flex flex-col justify-start items-center bg-[url('/template2/bg-phone-maroon.png')]">
      <motion.div 
      className="px-10"
      initial={{ opacity: 0, y: 50 }}
      whileInView={{ opacity: 1, y: 0 }}
...
const Gift = ({ currentUser }: { currentUser: BridalCouple| null }) => {
  ...
  return(
    <div className="min-h-screen relative w-[500px] text-2xl bg-[url('/template2/bg-phone-maroon.png')] md:py-10 flex flex-col justify-center items-center">
      <motion.div 
...
const Closing = ({ currentUser }: { currentUser: BridalCouple| null }) =>  {
  ...
  return(
    <div className="min-h-screen relative w-[500px] text-2xl py-5 bg-[url('/template2/bg-phone-maroon.png')] flex flex-col justify-start items-center">
...
export default HeritageOfIndonesiaMaroon;
